...
constexpr size_t DRAM_LOW_WATERMARK = static_cast<size_t>(0.2 * DRAM_WQ_SIZE);
constexpr size_t DRAM_HIGH_WATERMARK = static_cast<size_t>(0.8 * DRAM_WQ_SIZE);
